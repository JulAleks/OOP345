...
namespace sdds {
	...
	public:
		...
		//       as a second operand.
		//Add an operator += overload to the DataBase template. Your function receives as parameter the address of an object of template type T and copies the object into the collection attribute.
