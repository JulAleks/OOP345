...
namespace sdds {
    ...
    {
        if (this != &rhs) {
            setAuth(rhs.b_author);
            setTitle(rhs.b_title);
            setDesc(rhs.b_desc);
            setCount(rhs.b_country);
            setYear(rhs.b_year);
            setPrice(rhs.b_price);
        }
        else {
            return *this;
        }
    ...
    {
        if (this != &rhs) {
            setAuth(std::move(rhs.b_author));
            setTitle(std::move(rhs.b_title));
            setDesc(std::move(rhs.b_desc));
            setCount(std::move(rhs.b_country));
            setYear(std::move(rhs.b_year));
            setPrice(std::move(rhs.b_price));
            rhs.setEmpty();
        }
